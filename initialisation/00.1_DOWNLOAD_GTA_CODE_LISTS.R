...
## COUNTRIES/TERRITORTIES ####
if (!file.exists("../inputs/codelists/cl_flagstate_iso3.csv"))
  
  download.file("https://raw.githubusercontent.com/fdiwg/fdi-codelists/main/global/cwp/cl_flagstate_iso3.csv", destfile = "../inputs/codelists/cl_flagstate_iso3.csv", mode = "wb")
