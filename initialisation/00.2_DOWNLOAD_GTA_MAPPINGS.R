...
## GTA fleet to country ####
if(!file.exists("../inputs/mappings/codelist_mapping_fishingfleet_firms_flag_fao_cwp.csv"))
  
  download.file("https://raw.githubusercontent.com/fdiwg/fdi-mappings/main/global/firms/gta/codelist_mapping_fishingfleet_firms_flag_fao_cwp.csv", destfile = "../inputs/mappings/codelist_mapping_fishingfleet_firms_flag_fao_cwp.csv", mode = "wb")
