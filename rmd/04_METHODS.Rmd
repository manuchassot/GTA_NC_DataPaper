...
The "Methods" section provides a comprehensive description of the steps and procedures used to create the Nominal catch dataset from the five different datasets, each representing one tRFMO (Regional Fisheries Management Organization).
...
### Filtering for Southern Bluefin Tuna (SBT) Data from CCSBT:
