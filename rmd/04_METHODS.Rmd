...
require(flextable)
qflextable(as_grouped_data(datasets_links_processing, groups = c("RFMO") ))
```
...
tidy <- diffstratasnumber[c(1, 3, 4, 5, 6),]
...
knitr::include_graphics(("outputs/filtering_sbf/figures/Piechartsdimensions/Distribution.in.value.for.the.dimension...source.authority.pdf"))
