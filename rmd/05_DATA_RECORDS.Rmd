...
drive_auth()
nominal_files_recap <- read_sheet("https://docs.google.com/spreadsheets/d/13SJB2PYkCCdrzw8HNJMPFg0yXs0OSYY2mUOAl5dagUc/edit#gid=374572086", sheet = "Nominal catches")
...
All the dataframes used for the mapping and the metadata (Dublin Core) included are the following (\@ref(tab:mapping-files)).

```{r}

if(!(file.exists(here("inputs/Workflow/mapping_files.csv")))){
drive_auth()
mapping_files <- read_sheet("https://docs.google.com/spreadsheets/d/1xzXgIxjQm81Fg7PCgtdiwhkB9sgtPKk-NByQDRtAGrE/edit#gid=1158322074", sheet = "2023")
