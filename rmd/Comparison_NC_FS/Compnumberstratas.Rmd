...
```{r disapandapflextable,results="asis",out.width="100%", eval = (nrow(strates_perdues_first_10)!=0)}

qflextable2(disapandap, captionn=paste0("Disappearing or appearing strata between ",`titre_1`," and ",`titre_2`),columns_to_color=c("Difference in millions"),save_folder="Diffstratas",fig.pathinside=fig.path, grouped_data = c("Dimension" ,"measurement_unit",  "Loss / Gain" ))
