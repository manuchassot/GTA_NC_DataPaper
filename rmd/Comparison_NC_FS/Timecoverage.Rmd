...
map_unit_knit_list <- lapply(map, FUN = function_knitting, titre_init = titre_1, titre_final = titre_2,  folder = "Temporal", difference = FALSE, unique_analyse= unique_analyse)
