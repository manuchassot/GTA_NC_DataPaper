...
`r if(!unique_analyse){cat_title("# Introduction to the two datasets")}`


```{r titlecomparison, eval= FALSE,results='asis'}
...
```{r timecoverage, echo=FALSE, results='asis', child="Timecoverage.Rmd"}
...
```{r eval= FALSE, child = "Timecoveragecumulated.Rmd", results='asis'}
